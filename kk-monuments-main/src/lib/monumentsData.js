...
export const newsArticles = [
  ...
  // ============================================================
// НОВЫЕ ПАМЯТНИКИ — вставьте в нужные секции monumentsData.js
// ============================================================

// ── КРЕПОСТИ (добавить в секцию // Fortresses) ──────────────

  {
    id: 'kurganzha-kala',
    name: { ru: 'Курганча-Кала', en: 'Kurganzha-Kala', uz: 'Qurgʻancha-Qalʼa', qq: 'Qurǵansha-Qala' },
    category: 'fortresses', coords: [41.88, 60.72], century: 'II-I веке до нашей эры',
    facts: {
      ru: ['Небольшая сторожевая крепость, входившая в систему обороны Хорезма', 'Расположена на возвышенности, обеспечивавшей визуальный контроль над окрестностями', 'Раскопки выявили следы кратковременного, но интенсивного использования'],
      en: ['A small watchtower fortress that was part of the Khorezm defense system', 'Located on high ground providing visual control over the surroundings', 'Excavations revealed traces of brief but intensive use'],
      uz: ['Xorazm mudofaa tizimiga kiruvchi kichik qo\'riqchi qalʼa', 'Atrofni vizual nazorat qilishni ta\'minlagan balandlikda joylashgan', 'Qazishmalar qisqa muddatli, lekin intensiv foydalanish izlarini aniqladi'],
      qq: ['Xorezm qorǵanıs sistemasına kirgen kishi qárewil qala', 'Atraptı kóriw arqalı baqlaw támiyinlegen biyiklikte ornalasqan', 'Qazıwlar qısqa, biraq intensiv paydalanıs izlerin anıqladı'],
    },
  },
  {
    id: 'kyzylcha-kala',
    name: { ru: 'Кызылча-Кала', en: 'Kyzylcha-Kala', uz: 'Qizilcha-Qalʼa', qq: 'Qızılsha-Qala' },
    category: 'fortresses', coords: [41.91, 60.81], century: 'I-II веке нашей эры',
    facts: {
      ru: ['Малая «Красная крепость» — спутник более крупной Кызыл-Калы', 'Стены сложены из характерного красноватого обожжённого кирпича', 'Служила дополнительным форпостом на торговом пути вдоль древних каналов'],
      en: ['Small "Red Fortress" — a satellite of the larger Kyzyl-Kala', 'Walls are built from characteristic reddish fired brick', 'Served as an additional outpost on the trade route along ancient canals'],
      uz: ['Kichik "Qizil qalʼa" — kattaroq Qizil-Qalʼaning yo\'ldoshi', 'Devorlar xarakterli qizg\'ish pishirilgan g\'ishtdan qurilgan', 'Qadimiy kanallar bo\'ylab savdo yo\'lida qo\'shimcha chegara postı vazifasini bajargan'],
      qq: ['Kishi «Qızıl qala» — úlkenrek Qızıl-Qalaniń serigi', 'Diywalar xarakterli qızılshıl pısırılǵan kerpiishten qurılǵan', 'Gadimgi kanallar boyındaǵı sawda jolında qosımsha shek postı wazıypasın atqarǵan'],
    },
  },
  {
    id: 'kuyuk-kala',
    name: { ru: 'Куюк-Кала', en: 'Kuyuk-Kala', uz: 'Kuyuk-Qalʼa', qq: 'Kúyik-Qala' },
    category: 'fortresses', coords: [41.83, 60.74], century: 'III-IV веке нашей эры',
    facts: {
      ru: ['Название переводится как «Сожжённая крепость» — следы пожара видны по всей площади', 'Предположительно была уничтожена во время одного из набегов кочевых племён', 'Несмотря на разрушения, сохранились части оборонительных башен'],
      en: ['The name translates as "Burnt Fortress" — traces of fire are visible across the entire area', 'Presumably destroyed during one of the raids by nomadic tribes', 'Despite the destruction, parts of the defensive towers have survived'],
      uz: ['Nomi "Yondirilgan qalʼa" deb tarjima qilinadi — yong\'in izlari butun maydon bo\'ylab ko\'rinadi', 'Ko\'chmanchi qabilalardan birining hujumi paytida vayron qilingan deb taxmin qilinadi', 'Vayronagarchilikka qaramay, mudofaa minoralarining qismlari saqlanib qolgan'],
      qq: ['Atı «Ótlengen qala» dep awdarıladı — ot izleri pútkil maydan boyında kórinedi', 'Kóshpeli taypalardıń biriniń shablıwı waqtında buzılǵan dep esaplanadı', 'Buzılıwlarǵa qaramastan, qorǵaw minaʼlarınıń bólimleri saqlanǵan'],
    },
  },
  {
    id: 'kyzyl-uy-kala',
    name: { ru: 'Кызыл-Уй-Кала', en: 'Kyzyl-Uy-Kala', uz: 'Qizil-Uy-Qalʼa', qq: 'Qızıl-Úy-Qala' },
    category: 'fortresses', coords: [41.77, 60.67], century: 'II веке до нашей эры',
    facts: {
      ru: ['Название «Красный дом-крепость» указывает на жилой характер постройки', 'Небольшое укреплённое поместье, типичное для богатых землевладельцев древнего Хорезма', 'Внутри найдены остатки зернохранилища и ирригационных сооружений'],
      en: ['The name "Red House-Fortress" indicates the residential character of the structure', 'A small fortified estate typical of wealthy landowners of ancient Khorezm', 'Remains of a granary and irrigation structures were found inside'],
      uz: ['«Qizil uy-qalʼa» nomi inshootning turar-joy xarakterini ko\'rsatadi', 'Qadimgi Xorazm boy yer egalari uchun xos bo\'lgan kichik mustahkamlangan mulk', 'Ichida donxona va sug\'orish inshootlarining qoldiqlari topilgan'],
      qq: ['«Qızıl úy-qala» atı inshaaattıń turarjay xarakterın kórsetedi', 'Gadimgi Xorezm bay jer egeleri ushın xas bolǵan kishi bekemlengen múlk', 'Ishinde dánxana hám suwlandırıw inshaaatlarınıń qaldıqları tabılǵan'],
    },
  },
  {
    id: 'dzhigerbent-kala',
    name: { ru: 'Джигербент-Кала', en: 'Dzhigerbent-Kala', uz: 'Jigarband-Qalʼa', qq: 'Jigerband-Qala' },
    category: 'fortresses', coords: [41.72, 60.58], century: 'IV-III веке до нашей эры',
    facts: {
      ru: ['Одна из пограничных крепостей западной оборонительной линии Хорезма', 'Название связывают с тюркским словом «джигер» — печень, что в переносном смысле означает «сердце» или «центр»', 'Обнаружены следы гончарных мастерских и бытовой керамики'],
      en: ['One of the border fortresses of the western defensive line of Khorezm', 'The name is linked to the Turkic word "jiger" — liver, which figuratively means "heart" or "center"', 'Traces of pottery workshops and household ceramics were found'],
      uz: ['Xorazmning g\'arbiy mudofaa chizig\'ining chegara qalʼalaridan biri', 'Nom turk tilidan «jigar» so\'zi bilan bog\'liq — jigar, majoziy ma\'noda «yurak» yoki «markaz»', 'Kulolchilik ustaxonalari va maishiy sopol idishlar izlari topilgan'],
      qq: ['Xorezmniń batıs qorǵanıs liniyasınıń shek qalalarınan biri', 'At túrkiy «jiyer» sózine baylanıslı — jiyer, kóshpeli mániste «júrek» yamasa «oray»', 'Kulalsherlik ustaxanaları hám turmıslıq kulalsherlik izleri tabılǵan'],
    },
  },
  {
    id: 'shahsenem',
    name: { ru: 'Шахсенем', en: 'Shahsenem', uz: 'Shohsenem', qq: 'Shahsenem' },
    category: 'fortresses', coords: [39.85, 57.30], century: 'IV-VIII веке нашей эры', featured: false,
    facts: {
      ru: ['Крупный средневековый город-крепость на южной границе Хорезма', 'Названа в честь легендарной красавицы Шахсенем из туркменского эпоса', 'Площадь городища превышает 100 гектаров — одно из крупнейших в регионе'],
      en: ['A large medieval fortress-city on the southern border of Khorezm', 'Named after the legendary beauty Shahsenem from the Turkmen epic', 'The area of the settlement exceeds 100 hectares — one of the largest in the region'],
      uz: ['Xorazmning janubiy chegarasidagi yirik o\'rta asr shahar-qalʼasi', 'Turkman eposidagi afsonaviy go\'zal Shohsenem sharafiga nomlangan', 'Shaharcha maydoni 100 gektardan oshadi — mintaqadagi eng yiriklardan biri'],
      qq: ['Xorezmniń tústik shegarasındaǵı iri orta ásir qala-qalası', 'Túrkmen eposındaǵı afsanawiy gúzel Shahsenem sharafına ataǵan', 'Qala maydanı 100 gektardan artıq — aymaqdaǵı eń irilerinen biri'],
    },
  },
  {
    id: 'kerder-kala',
    name: { ru: 'Кердер-Кала', en: 'Kerder-Kala', uz: 'Kerder-Qalʼa', qq: 'Kerder-Qala' },
    category: 'fortresses', coords: [42.60, 59.30], century: 'VII-VIII веке нашей эры',
    facts: {
      ru: ['Центр исторической области Кердер на севере Хорезма', 'Упоминается в арабских источниках VIII века как важный административный центр', 'Раскопки показали высокий уровень городской культуры и развитое ремесло'],
      en: ['Center of the historical Kerder region in northern Khorezm', 'Mentioned in 8th-century Arabic sources as an important administrative center', 'Excavations showed a high level of urban culture and developed crafts'],
      uz: ['Shimoliy Xorazmdagi tarixiy Kerder viloyatining markazi', 'VIII asr arab manbalarida muhim ma\'muriy markaz sifatida tilga olinadi', 'Qazishmalar shahar madaniyatining yuqori darajasi va rivojlangan hunarmandchilikni ko\'rsatdi'],
      qq: ['Tústik Xorezmniń tariyxıy Kerder vilayatınıń orayı', 'VIII ásir arab dereklerinde áhmiyetli ádministrativ oray retinde ataladı', 'Qazıwlar qala mádeniyetiniń joqarı dárejesi hám rawajlanǵan hunarmentshilikti kórsetti'],
    },
  },
  {
    id: 'artek-kala',
    name: { ru: 'Артек-Кала', en: 'Artek-Kala', uz: 'Artek-Qalʼa', qq: 'Artek-Qala' },
    category: 'fortresses', coords: [41.86, 60.68], century: 'III веке до нашей эры',
    facts: {
      ru: ['Небольшая укреплённая усадьба эллинистического периода Хорезма', 'В находках прослеживается влияние греко-бактрийской культуры', 'Хорошо сохранились угловые башни прямоугольного плана'],
      en: ['A small fortified estate from the Hellenistic period of Khorezm', 'Greek-Bactrian cultural influence is traceable in the finds', 'Corner towers of rectangular plan are well preserved'],
      uz: ['Xorazmning ellinistik davriga oid kichik mustahkamlangan mulk', 'Topilmalarda greko-baktriya madaniyatining ta\'siri seziladi', 'To\'g\'ri burchakli rejadagi burchak minoralari yaxshi saqlanib qolgan'],
      qq: ['Xorezmniń ellinistik dáwirine tiyisli kishi bekemlengen múlk', 'Tabılmalarda greko-baktriya mádeniyetiniń tásiri seziledi', 'Tórtbúrısh jobadaǵı búrısh minaʼları jaqsı saqlanǵan'],
    },
  },
  {
    id: 'berkut-kala',
    name: { ru: 'Беркут-Кала', en: 'Berkut-Kala', uz: 'Burgut-Qalʼa', qq: 'Berkut-Qala' },
    category: 'fortresses', coords: [41.94, 60.78], century: 'VI-VIII веке нашей эры',
    facts: {
      ru: ['«Орлиная крепость» — названа по орлу, изображённому на найденном здесь штандарте', 'Входила в густую сеть раннесредневековых замков-усадеб Хорезма', 'Раскопки выявили богатые стенные росписи с изображением пиров и охоты'],
      en: ['"Eagle Fortress" — named after the eagle depicted on a standard found here', 'Was part of the dense network of early medieval manor-castles of Khorezm', 'Excavations revealed rich wall paintings depicting feasts and hunting scenes'],
      uz: ['«Burgut qalʼasi» — bu yerda topilgan bayroqdagi burgut tasviri sharafiga nomlangan', 'Xorazmning erta o\'rta asrlar qo\'rg\'on-mulklari zich tarmog\'iga kirgan', 'Qazishmalar ziyofat va ov sahnalarini tasvirlaydigan boy devor rasmlarini ochib berdi'],
      qq: ['«Berkut qalası» — bul jerde tabılǵan bayraqdaǵı berkut suwreti sharafına ataǵan', 'Xorezmniń erte orta ásirler qorǵan-múlkleri tıǵız tarmaqqa kirgen', 'Qazıwlar toy hám aw sahnaların sáwleletuwshi bay diywarlıq suwretlerin ashıp berdi'],
    },
  },
  {
    id: 'kyuldursun-kala',
    name: { ru: 'Кульдурсун-Кала', en: 'Kyuldursun-Kala', uz: 'Kuldursun-Qalʼa', qq: 'Kúldursun-Qala' },
    category: 'fortresses', coords: [41.83, 60.77], century: 'I-II веке нашей эры',
    facts: {
      ru: ['Средняя по размеру крепость системы Гульдурсун-Кала', 'Располагалась между Большим и Малым Гульдурсуном, образуя единый оборонительный узел', 'Найдены монеты хорезмийских царей I–II вв. н. э.'],
      en: ['A medium-sized fortress in the Guldursun-Kala system', 'Located between Big and Small Guldursun, forming a single defensive node', 'Coins of Khorezm kings of the 1st–2nd centuries AD were found'],
      uz: ['Guldursun-Qalʼa tizimidagi o\'rtacha kattalikdagi qalʼa', 'Katta va Kichik Guldursun o\'rtasida joylashib, yagona mudofaa tugunini tashkil qilgan', 'I–II asrlarga oid Xorazm shohlari tangalari topilgan'],
      qq: ['Guldursun-Qala sistemasındaǵı orta ólshemli qala', 'Ullı hám Kishi Guldursun arasında ornalasıp, birden-bir qorǵanıs tóbeni quraǵan', 'I–II ásirlerge tiyisli Xorezm shaxları tıyınları tabılǵan'],
    },
  },
  {
    id: 'uzonkyr-kala',
    name: { ru: 'Узункыр-Кала', en: 'Uzonkyr-Kala', uz: 'Uzunqir-Qalʼa', qq: 'Uzınqır-Qala' },
    category: 'fortresses', coords: [41.75, 60.62], century: 'IV-III веке до нашей эры',
    facts: {
      ru: ['Название «Длинный берег-крепость» указывает на протяжённость оборонительных стен', 'Имеет нетипичную вытянутую форму, приспособленную к рельефу местности', 'Одна из наименее изученных крепостей хорезмийской системы'],
      en: ['The name "Long Shore-Fortress" refers to the length of the defensive walls', 'Has an atypical elongated shape adapted to the terrain', 'One of the least studied fortresses of the Khorezm system'],
      uz: ['«Uzun qirg\'oq-qalʼa» nomi mudofaa devorlarining uzunligiga ishora qiladi', 'Relyefga moslashtirilgan noodatiy cho\'zilgan shaklga ega', 'Xorazm tizimining kam o\'rganilgan qalʼalaridan biri'],
      qq: ['«Uzın jaq-qala» atı qorǵanıs diywalarınıń uzınlıǵına ishorat etedi', 'Relyefke moslastırılǵan ásayıp sozılǵan shaklge iye', 'Xorezm sistemasınıń az úyrenilgen qalalarınan biri'],
    },
  },
  {
    id: 'aydar-kala',
    name: { ru: 'Айдар-Кала', en: 'Aydar-Kala', uz: 'Aydar-Qalʼa', qq: 'Aydar-Qala' },
    category: 'fortresses', coords: [41.89, 60.74], century: 'II-III веке нашей эры',
    facts: {
      ru: ['Названа в честь популярного каракалпакского имени Айдар — «лунный» или «счастливый»', 'Небольшая квадратная крепость с башнями по углам', 'Обнаружены следы длительного обитания нескольких поколений'],
      en: ['Named after the popular Karakalpak name Aydar — "lunar" or "happy"', 'A small square fortress with towers at the corners', 'Traces of long habitation by several generations were found'],
      uz: ['Mashhur qoraqalpoq ismi Aydar sharafiga nomlangan — «oy» yoki «baxtli»', 'Burchaklarda minoralari bo\'lgan kichik kvadrat qalʼa', 'Bir necha avlodning uzoq yashashi izlari aniqlangan'],
      qq: ['Belgili qaraqalpaq atı Aydar sharafına ataǵan — «ay» yamasa «baxıtlı»', 'Búrıshlarında minaʼları bar kishi kvadrat qala', 'Bir neshe áwladtıń uzaq jasawı izleri tabılǵan'],
    },
  },
  {
    id: 'kunya-uaz-kala',
    name: { ru: 'Куня-Уаз-Кала', en: 'Kunya-Uaz-Kala', uz: 'Koʻhna-Voʻaz-Qalʼa', qq: 'Kóne-Waz-Qala' },
    category: 'fortresses', coords: [41.96, 60.70], century: 'V-VI веке нашей эры',
    facts: {
      ru: ['«Старая Уаз-крепость» — предшественница более позднего поселения', 'Расположена вблизи древнего русла реки, обеспечивавшего водоснабжение', 'Следы перестройки указывают на несколько периодов активного использования'],
      en: ['The "Old Uaz Fortress" — predecessor of a later settlement', 'Located near an ancient riverbed that provided water supply', 'Traces of reconstruction indicate several periods of active use'],
      uz: ['«Qadimgi Vоʻaz-qalʼa» — keyingi manzilgohning salafi', 'Suv ta\'minotini ta\'minlagan qadimiy daryo o\'zani yaqinida joylashgan', 'Qayta qurilish izlari faol foydalanishning bir necha davrini ko\'rsatadi'],
      qq: ['«Kóne Waz-qala» — keyingirek mekenniń aldıngısı', 'Suw támiynatın qámtigen gadimgi dárya ózeni jaqınında ornalasqan', 'Qayta qurılıs izleri aktiv paydalanıstıń bir neshe dáwirin kórsetedi'],
    },
  },
  {
    id: 'teshik-kala',
    name: { ru: 'Тешик-Кала', en: 'Teshik-Kala', uz: 'Teshik-Qalʼa', qq: 'Teshik-Qala' },
    category: 'fortresses', coords: [41.92, 60.76], century: 'VII-VIII веке нашей эры',
    facts: {
      ru: ['Название «Дырявая крепость» связано с многочисленными проломами в стенах', 'Одна из лучше всего сохранившихся раннесредневековых крепостей Хорезма', 'Внутри найдены оссуарии и следы зороастрийских погребальных обрядов'],
      en: ['The name "Holey Fortress" is associated with numerous breaches in the walls', 'One of the best-preserved early medieval fortresses of Khorezm', 'Ossuaries and traces of Zoroastrian burial rites were found inside'],
      uz: ['«Teshik qalʼa» nomi devorlardagi ko\'plab yoriqlar bilan bog\'liq', 'Xorazmning erta o\'rta asrlardagi eng yaxshi saqlanib qolgan qalʼalaridan biri', 'Ichida ossuuriylar va zardushtiylik dafn marosimlari izlari topilgan'],
      qq: ['«Teshik qala» atı diywallarındaǵı kóp sanawlı jarıqlar menen baylanıslı', 'Xorezmniń erte orta ásirlerindegi eń jaqsı saqlanǵan qalalarınan biri', 'Ishinde ossuuriylar hám zardushtıylıq dapn rituallarınıń izleri tabılǵan'],
    },
  },
  {
    id: 'dzhar-kala',
    name: { ru: 'Джар-Кала', en: 'Dzhar-Kala', uz: 'Jar-Qalʼa', qq: 'Jar-Qala' },
    category: 'fortresses', coords: [41.74, 60.64], century: 'III-IV веке нашей эры',
    facts: {
      ru: ['«Обрывистая крепость» — возведена на краю естественного обрыва для лучшей защиты', 'Использовала рельеф как дополнительный элемент обороны', 'Небольшой размер указывает на функцию пограничного наблюдательного поста'],
      en: ['"Cliff Fortress" — built on the edge of a natural cliff for better protection', 'Used the terrain as an additional element of defense', 'Small size indicates the function of a border observation post'],
      uz: ['«Qoya qalʼa» — yaxshiroq himoya uchun tabiiy qoya chetiga qurilgan', 'Relyefni qo\'shimcha mudofaa elementi sifatida ishlatgan', 'Kichik o\'lcham chegara kuzatuv postining vazifasini ko\'rsatadi'],
      qq: ['«Jar qala» — jaqsıraq qorǵaw ushın tábiyiy jardıń shetine qurılǵan', 'Relyefti qosımsha qorǵanıs elementi retinde paydalanǵan', 'Kishi ólshem shek baqlaw postı wazıypasın kórsetedi'],
    },
  },

// ── ПОСЕЛЕНИЯ (добавить в секцию // Settlements) ─────────────

  {
    id: 'khazarasp',
    name: { ru: 'Хазарасп', en: 'Khazarasp', uz: 'Xazarasp', qq: 'Xazarasp' },
    category: 'settlements', coords: [41.32, 61.07], century: 'IV веке до нашей эры',
    facts: {
      ru: ['Один из древнейших непрерывно обитаемых городов Хорезма с 2500-летней историей', 'Название переводится как «Тысяча лошадей» — свидетельство значимости коневодства в регионе', 'Упоминается в трудах древнегреческих историков как важный город Хорезма'],
      en: ['One of the oldest continuously inhabited cities of Khorezm with a 2500-year history', 'The name translates as "A Thousand Horses" — evidence of the importance of horse breeding in the region', 'Mentioned in the works of ancient Greek historians as an important city of Khorezm'],
      uz: ['2500 yillik tarixga ega Xorazmning eng qadimiy uzluksiz aholi yashaydigan shaharlaridan biri', 'Nomi "Ming ot" deb tarjima qilinadi — mintaqada otchilik muhimligidan dalolat beradi', 'Qadimgi yunon tarixchilarining asarlarida Xorazmning muhim shahri sifatida tilga olinadi'],
      qq: ['2500 jıllıq tariyxqa iye Xorezmniń eń gadimgi úzliksiz mekenlestiriletın qalalarınan biri', 'Atı «Mıń at» dep awdarıladı — aymaqta atshılıqtıń áhmiyetinen dalálat beredi', 'Gadimgi grek tariyxshılarınıń jumıslarında Xorezmniń áhmiyetli qalası retinde ataladı'],
    },
  },
  {
    id: 'dzhanpyk-kala',
    name: { ru: 'Джанпык-Кала', en: 'Dzhanpyk-Kala', uz: 'Janpiq-Qalʼa', qq: 'Janpıq-Qala' },
    category: 'settlements', coords: [42.55, 59.20], century: 'X-XII веке нашей эры',
    facts: {
      ru: ['Средневековый город северного Хорезма, упоминаемый в арабских источниках', 'Служил важным перевалочным пунктом на пути к степям Дашт-и-Кыпчак', 'Раскопки вскрыли остатки городского базара и ремесленных кварталов'],
      en: ['A medieval city of northern Khorezm, mentioned in Arabic sources', 'Served as an important transit point on the way to the Dasht-i-Kipchak steppes', 'Excavations uncovered remains of a city bazaar and craft quarters'],
      uz: ['Arab manbalarida tilga olingan shimoliy Xorazmning o\'rta asrlar shahri', 'Dasht-i-Qipchoq dashtlariga yo\'lda muhim tranzit nuqtasi bo\'lgan', 'Qazishmalar shahar bozori va hunarmandchilik kvartallarining qoldiqlarini ochib berdi'],
      qq: ['Arab dereklerinde atalatın tústik Xorezmniń orta ásirler qalası', 'Dasht-i-Qıpshaq daları jolında áhmiyetli tranzit noqtası bolǵan', 'Qazıwlar qala bazarı hám hunarmentshilik kvartallarınıń qaldıqların ashıp berdi'],
    },
  },
  {
    id: 'kokcha-settlements',
    name: { ru: 'Поселения Кокча', en: 'Kokcha Settlements', uz: 'Ko\'kcha manzilgohlari', qq: 'Kóksha mekenleri' },
    category: 'settlements', coords: [42.40, 59.80], century: 'III-II тысячелетии до нашей эры',
    facts: {
      ru: ['Район древних поселений бронзового века на территории современного Каракалпакстана', 'Здесь обнаружены материалы тазабагьябской культуры — одной из древнейших в регионе', 'Находки свидетельствуют о развитом скотоводстве и ирригационном земледелии'],
      en: ['A district of ancient Bronze Age settlements in the territory of modern Karakalpakstan', 'Materials of the Tazabagyab culture — one of the oldest in the region — were found here', 'Finds indicate developed animal husbandry and irrigated agriculture'],
      uz: ['Zamonaviy Qoraqalpog\'iston hududidagi bronza asri qadimiy manzilgohlarining tumani', 'Bu yerda mintaqadagi eng qadimiylardan biri bo\'lgan tazabag\'yob madaniyati materiallari topilgan', 'Topilmalar rivojlangan chorvachilik va sug\'orma dehqonchilikdan dalolat beradi'],
      qq: ['Házirgi Qaraqalpaqstan hududındaǵı bronza dáwiri gadimgi mekenleri rayonı', 'Bul jerde aymaqdaǵı eń gadimgilerinen biri bolǵan tazabagʼyab mádeniyeti materialleri tabılǵan', 'Tabılmalar rawajlanǵan mal sharwashılıǵı hám suwlandırmalı eginshelikten dalálat beredi'],
    },
  },
  {
    id: 'chimbay-settlement',
    name: { ru: 'Чимбайское городище', en: 'Chimbay Settlement', uz: 'Chimboy shaharchasi', qq: 'Shımbay qalashası' },
    category: 'settlements', coords: [42.93, 59.78], century: 'X-XIII веке нашей эры',
    facts: {
      ru: ['Остатки средневекового предшественника современного города Чимбай', 'Занимал выгодное положение у переправы через один из рукавов Амударьи', 'Найдены предметы торговли из Ирана, Китая и русских земель'],
      en: ['Remains of the medieval predecessor of the modern city of Chimbay', 'Occupied a favorable position at a crossing over one of the Amu Darya branches', 'Trade items from Iran, China, and Russian lands were found'],
      uz: ['Zamonaviy Chimboy shahrining o\'rta asrlar salafining qoldiqlari', 'Amudaryoning tarmoqlaridan biri bo\'ylab kechuvda qulay joylashgan', 'Eron, Xitoy va Rus yerlaridan kelgan savdo buyumlari topilgan'],
      qq: ['Házirgi Shımbay qalasınıń orta ásir aldıngısınıń qaldıqları', 'Ámiwdáryanıń tarmaqlıqlarınan birinen keshiw janında qolay jaylasqan', 'İran, Qıtay hám Orus jerlerinen kelgen sawda buyımları tabılǵan'],
    },
  },

// ── МАВЗОЛЕИ (добавить в секцию // Mausoleums) ───────────────

  {
    id: 'nazlumkhan-sulu',
    name: { ru: 'Мавзолей Назлумхан-Сулу', en: 'Nazlumkhan Sulu Mausoleum', uz: 'Nazlumxon Suluw', qq: 'Nazlumxan Sulıw' },
    category: 'mausoleums', coords: [42.46, 59.57], century: 'XIII-XIV в.',
    facts: {
      ru: ['Посвящён другой легендарной красавице каракалпакского фольклора — Назлумхан', 'Архитектура близка к мавзолею Мазлумхан-Сулу и относится к той же эпохе', 'Является местом паломничества для женщин, молящихся о красоте и счастье в браке'],
      en: ['Dedicated to another legendary beauty of Karakalpak folklore — Nazlumkhan', 'The architecture is close to the Mazlumkhan Sulu mausoleum and belongs to the same era', 'Is a pilgrimage site for women praying for beauty and happiness in marriage'],
      uz: ['Qoraqalpoq folklorining yana bir afsonaviy go\'zali — Nazlumxonga bag\'ishlangan', 'Me\'morchiligi Mazlumxon Suluw maqbarasiga yaqin va bir davrga tegishli', 'Go\'zallik va nikohda baxt tilagan ayollar uchun ziyoratgoh'],
      qq: ['Qaraqalpaq folklorınıń basqa afsanawiy gúzeli — Nazlumxanǵa arnalǵan', 'Arxitekturası Mazlumxan Sulıw mazarına jaqın hám birdey dáwirge tiyisli', 'Gúzellik hám neke baxtı tilek etken áyeller ushın zıyarat orını'],
    },
  },
  {
    id: 'kenеges-biy',
    name: { ru: 'Мавзолей Кенегес-Бия', en: 'Keneges Biy Mausoleum', uz: 'Keneges Biy maqbarasi', qq: 'Keneges Biy mazarı' },
    category: 'mausoleums', coords: [42.38, 59.48], century: 'XVIII в.',
    facts: {
      ru: ['Посвящён Кенегес-Бию — известному предводителю каракалпакского рода Кенегес', 'Относится к периоду каракалпакской государственности в низовьях Сырдарьи', 'Архитектура отражает позднесредневековые традиции мавзолеестроения Приаралья'],
      en: ['Dedicated to Keneges Biy — a famous leader of the Karakalpak Keneges clan', 'Belongs to the period of Karakalpak statehood in the lower reaches of the Syr Darya', 'Architecture reflects late medieval traditions of mausoleum construction in the Aral Sea region'],
      uz: ['Qoraqalpoq Keneges urug\'ining mashhur boshlig\'i Keneges Biyga bag\'ishlangan', 'Sirdaryoning quyi oqimidagi qoraqalpoq davlatchiligi davriga tegishli', 'Me\'morchilik Orolbo\'yi geç o\'rta asr maqbara qurilishi an\'analarini aks ettiradi'],
      qq: ['Qaraqalpaq Keneges urıwınıń belgili basshısı Keneges Biyge arnalǵan', 'Sırdáryanıń tómengi aǵımındaǵı qaraqalpaq mámleketshilik dáwirine tiyisli', 'Arxitektura Aral boyı keyingi orta ásir mazar qurlısı dástúrlerın sáwlelendiredi'],
    },
  },
  {
    id: 'karaman-ata',
    name: { ru: 'Мавзолей Караман-Ата', en: 'Karaman Ata Mausoleum', uz: 'Qoramon Ota maqbarasi', qq: 'Qaraman Ata mazarı' },
    category: 'mausoleums', coords: [42.15, 58.90], century: 'XIV-XV в.',
    facts: {
      ru: ['Посвящён суфийскому святому, почитаемому среди каракалпаков и туркмен', 'Расположен на краю плато Устюрт — место уединения суфийских отшельников', 'Ежегодно привлекает паломников из разных регионов Центральной Азии'],
      en: ['Dedicated to a Sufi saint revered among Karakalpaks and Turkmens', 'Located on the edge of the Ustyurt Plateau — a place of retreat for Sufi hermits', 'Annually attracts pilgrims from different regions of Central Asia'],
      uz: ['Qoraqalpoqlar va turkmanlar orasida hurmat qilinadigan so\'fiy avliyoga bag\'ishlangan', 'Ustyurt platosining chetida joylashgan — so\'fiy zohidlarning xilvat joyi', 'Har yili Markaziy Osiyoning turli mintaqalaridan ziyoratchilarni jalb qiladi'],
      qq: ['Qaraqalpaqlar hám túrkmenler arasında húrmet kóretın sufiy awliyaǵa arnalǵan', 'Ústirt platosınıń shetin de ornalasqan — sufiy zohidleriniń xilwat orını', 'Jıl sayın Orta Aziyaniń túrli rayonlarınan zıyaratshılardı tartadı'],
    },
  },
  {
    id: 'dzhuma-ata',
    name: { ru: 'Мавзолей Джума-Ата', en: 'Dzhuma Ata Mausoleum', uz: 'Juma Ota maqbarasi', qq: 'Juma Ata mazarı' },
    category: 'mausoleums', coords: [42.50, 59.35], century: 'XV в.',
    facts: {
      ru: ['Посвящён местному праведнику, в честь которого назван день недели «джума» (пятница)', 'Небольшой по размерам, но почитаемый мавзолей в северном Каракалпакстане', 'По пятницам здесь традиционно собираются верующие для молитвы'],
      en: ['Dedicated to a local righteous man after whom the day of the week "juma" (Friday) is named', 'A small but revered mausoleum in northern Karakalpakstan', 'Believers traditionally gather here for prayer on Fridays'],
      uz: ['Juma kuni (juma) o\'z nomini olgan mahalliy solih odamga bag\'ishlangan', 'Shimoliy Qoraqalpog\'iston da kichik, lekin hurmat qilinadigan maqbara', 'Juma kunlari bu yerda an\'anaviy ravishda ibodat uchun mo\'minlar to\'planadi'],
      qq: ['Juma kúni (juma) atın alǵan jergilikli salıh adamǵa arnalǵan', 'Tústik Qaraqalpaqstanda kishi, biraq húrmet kóretın mazar', 'Juma kúnleri bul jerde dástúriy túrde namaz ushın iseniwshiler jiynalaadı'],
    },
  },
  {
    id: 'seyt-ahun',
    name: { ru: 'Мавзолей Сейит-Ахун', en: 'Seyt Ahun Mausoleum', uz: 'Sayt Oxun maqbarasi', qq: 'Seyt Axun mazarı' },
    category: 'mausoleums', coords: [42.42, 59.52], century: 'XVI-XVII в.',
    facts: {
      ru: ['Посвящён исламскому учёному и мыслителю, оставившему след в духовной жизни Каракалпакстана', 'Мавзолей служил центром исламского образования в регионе', 'Рядом сохранились остатки медресе, функционировавшего при мавзолее'],
      en: ['Dedicated to an Islamic scholar and thinker who left a mark on the spiritual life of Karakalpakstan', 'The mausoleum served as a center of Islamic education in the region', 'Remains of a madrassa that functioned near the mausoleum have survived nearby'],
      uz: ['Qoraqalpog\'iston ruhiy hayotida iz qoldirgan islom olimi va mutafakkirga bag\'ishlangan', 'Maqbara mintaqada islom ta\'limining markazi bo\'lgan', 'Yaqinida maqbara yonida faoliyat ko\'rsatgan madrasaning qoldiqlari saqlanib qolgan'],
      qq: ['Qaraqalpaqstan ruwxıy ómirinde iz qaldırǵan islam alımı hám oyshılına arnalǵan', 'Mazar aymaqta islam bilim beriw orayı bolǵan', 'Jaqınında mazar janında jumıs istegen medreseniń qaldıqları saqlanǵan'],
    },
  },
  {
    id: 'alim-ata',
    name: { ru: 'Мавзолей Алим-Ата', en: 'Alim Ata Mausoleum', uz: 'Olim Ota maqbarasi', qq: 'Álim Ata mazarı' },
    category: 'mausoleums', coords: [42.28, 59.60], century: 'XV-XVI в.',
    facts: {
      ru: ['«Отец знаний» — посвящён легендарному учёному, знавшему Коран наизусть', 'Место поклонения для студентов и учёных, просящих о даровании мудрости', 'Простая архитектура подчёркивает аскетический образ жизни святого'],
      en: ['"Father of Knowledge" — dedicated to a legendary scholar who knew the Quran by heart', 'A place of veneration for students and scholars praying for wisdom', 'Simple architecture emphasizes the ascetic lifestyle of the saint'],
      uz: ['«Bilimlar otasi» — Qur\'onni yod bilgan afsonaviy olimga bag\'ishlangan', 'Hikmat tilagan talabalar va olimlar uchun sig\'inish joyi', 'Oddiy me\'morchilik avliyoning asketik turmush tarzini ta\'kidlaydi'],
      qq: ['«Bilimler atası» — Qurdı jatqa bilgen afsanawiy alımǵa arnalǵan', 'Danalıq tilek etken studentler hám alımlar ushın tabınıw orını', 'Sadde arxitektura awlıyanıń asketikalıq turmıs tarzın kórsetedi'],
    },
  },
  {
    id: 'khodzha-ilyas',
    name: { ru: 'Мавзолей Ходжа-Ильяс', en: 'Khodzha Ilyas Mausoleum', uz: 'Xoja Ilyas maqbarasi', qq: 'Xoja İlyas mazarı' },
    category: 'mausoleums', coords: [42.32, 59.44], century: 'XIV в.',
    facts: {
      ru: ['Посвящён пророку Илье (Ильясу) — почитаемому в исламской традиции как покровитель путников и рыбаков', 'Расположен вблизи древнего рыбацкого поселения на берегу водоёма', 'Место паломничества рыбаков Приаралья, молящихся об удаче на промысле'],
      en: ['Dedicated to the prophet Elijah (Ilyas) — revered in Islamic tradition as the patron of travelers and fishermen', 'Located near an ancient fishing settlement on the shore of a body of water', 'A pilgrimage site for Aral Sea fishermen praying for luck in their trade'],
      uz: ['Islom an\'anasida yo\'lovchilar va baliqchilarning homiysi sifatida hurmat qilinadigan Ilyos payg\'ambarga bag\'ishlangan', 'Suv havzasi qirg\'og\'idagi qadimiy baliqchilar manzilgohi yaqinida joylashgan', 'Kasb-korida omad tilagan Orolbo\'yi baliqchilari uchun ziyoratgoh'],
      qq: ['Islam dástúrinde jolawshılar hám balıqshılardıń himayashısı retinde húrmet kóretın Ilyas payǵambarǵa arnalǵan', 'Suw kóli jağasındaǵı gadimgi balıqshılar mekeni jaqınında ornalasqan', 'Kásipte baxıt tilek etken Aral boyı balıqshıları ushın zıyarat orını'],
    },
  },
  {
    id: 'kazybek-biy',
    name: { ru: 'Мавзолей Казыбек-Бия', en: 'Kazybek Biy Mausoleum', uz: 'Qozibek Biy maqbarasi', qq: 'Qazıbek Biy mazarı' },
    category: 'mausoleums', coords: [42.35, 59.58], century: 'XVIII в.',
    facts: {
      ru: ['Посвящён Казыбек-Бию — знаменитому судье и оратору казахско-каракалпакского пограничья', 'Казыбек-Бий известен как один из «Трёх биев» — мудрецов казахского народа', 'Мавзолей символизирует исторические связи казахского и каракалпакского народов'],
      en: ['Dedicated to Kazybek Biy — a famous judge and orator of the Kazakh-Karakalpak borderland', 'Kazybek Biy is known as one of the "Three Biys" — wise men of the Kazakh people', 'The mausoleum symbolizes the historical ties between the Kazakh and Karakalpak peoples'],
      uz: ['Qozoq-qoraqalpoq chegarasining mashhur qozisi va notiqi Qozibek Biyga bag\'ishlangan', 'Qozibek Biy qozoq xalqining donishmandlari — «Uch biy»dan biri sifatida tanilgan', 'Maqbara qozoq va qoraqalpoq xalqlari o\'rtasidagi tarixiy aloqalarni ramziy ifodalaydi'],
      qq: ['Qazaq-Qaraqalpaq shegara aymaǵınıń belgili qazısı hám notıqı Qazıbek Biyge arnalǵan', 'Qazıbek Biy qazaq halqınıń danalıq iyesi — «Úsh biy»den biri retinde tanılǵan', 'Mazar qazaq hám qaraqalpaq halıqları arasındaǵı tariyxıy baylanıslardı ramzıy ifodalaydi'],
    },
  },

// ── ДРУГИЕ (добавить в секцию // Other) ──────────────────────

  {
    id: 'aral-port-remains',
    name: { ru: 'Остатки Аральского порта', en: 'Aral Port Remains', uz: 'Orol porti qoldiqlari', qq: 'Aral portınıń qaldıqları' },
    category: 'other', coords: [43.76, 58.66], century: 'XIX-XX в.',
    facts: {
      ru: ['Некогда оживлённый порт, принимавший суда с рыбой, хлопком и товарами всего региона', 'После отступления воды порт оказался посреди пустыни в 100 км от берега', 'Сохранились причальные сооружения, склады и портовое оборудование'],
      en: ['Once a busy port that received ships carrying fish, cotton, and goods from across the region', 'After the water receded, the port found itself in the middle of the desert 100 km from the shore', 'Mooring structures, warehouses, and port equipment have survived'],
      uz: ['Bir vaqtlar baliq, paxta va butun mintaqa tovarlari bilan kemalarni qabul qilgan gavjum port', 'Suv chekinganidan keyin port qirg\'oqdan 100 km uzoqlikda cho\'l o\'rtasida qoldi', 'Portlash inshootlari, omborlar va port jihozlari saqlanib qolgan'],
      qq: ['Bir waqıtlar balıq, paxta hám pútkil aymaq tovarları menen keme qabıl etken júdá iri port', 'Suw shegingennnen keyin port jaqadan 100 km alıslıqta shól ortasında qaldı', 'Demewlew inshaaatları, ambarlar hám port jihazları saqlanǵan'],
    },
  },
  {
    id: 'irrigation-canals',
    name: { ru: 'Древние ирригационные каналы Хорезма', en: 'Ancient Irrigation Canals of Khorezm', uz: 'Xorazm qadimiy sug\'orish kanallari', qq: 'Xorezm gadimgi suwlandırıw kanallari' },
    category: 'other', coords: [41.90, 60.60], century: 'V веке до нашей эры', featured: false,
    facts: {
      ru: ['Разветвлённая сеть каналов длиной сотни километров, орошавшая земли древнего Хорезма', 'Инженерное чудо древности — каналы прорыты без современных технологий на протяжении веков', 'Многие каналы видны со спутника как следы исчезнувшей цивилизации'],
      en: ['A branching network of canals hundreds of kilometers long that irrigated the lands of ancient Khorezm', 'An engineering wonder of antiquity — canals dug without modern technology over centuries', 'Many canals are visible from satellite as traces of a vanished civilization'],
      uz: ['Qadimgi Xorazm yerlarini sug\'organ yuzlab kilometr uzunlikdagi tarmoqlangan kanallar tarmog\'i', 'Qadimiyatning muhandislik mo\'jizasi — kanallar asrlar davomida zamonaviy texnologiyalarsiz qazilgan', 'Ko\'p kanallar sun\'iy yo\'ldoshdan yo\'qolgan sivilizatsiya izlari sifatida ko\'rinadi'],
      qq: ['Gadimgi Xorezm jerlerın suwlandırǵan juzlaǵan kilometr uzınlıqtaǵı tarmaqlı kanallar tarmaqları', 'Gadimgiliktiń injenerlik keremeti — kanallar ásirler dawamında házirgi texnologiyalarsız qazılǵan', 'Kóp kanallar suniy joldosstan joq bolǵan tsivilizatsiya izleri retinde kórinedi'],
    },
  },
  {
    id: 'historical-bridges',
    name: { ru: 'Исторические мосты через Амударью', en: 'Historical Bridges over Amudarya', uz: 'Amudaryo ustidagi tarixiy ko\'priklar', qq: 'Ámiwdárya ústindegi tariyxıy kópirler' },
    category: 'other', coords: [42.20, 60.10], century: 'XIX в.',
    facts: {
      ru: ['Переправы через Амударью играли ключевую роль в торговле и военных походах на протяжении тысячелетий', 'Первые постоянные мосты появились в XIX веке с приходом российской администрации', 'Некоторые исторические опоры и переправы сохранились как памятники инженерной мысли'],
      en: ['Crossings over the Amu Darya played a key role in trade and military campaigns for millennia', 'The first permanent bridges appeared in the 19th century with the arrival of Russian administration', 'Some historical supports and crossings have survived as monuments of engineering thought'],
      uz: ['Amudaryo bo\'ylab o\'tishlar ming yillar davomida savdo va harbiy yurishlarda hal qiluvchi rol o\'ynagan', 'Birinchi doimiy ko\'priklar XIX asrda Rossiya ma\'muriyati kelishi bilan paydo bo\'lgan', 'Ba\'zi tarixiy tayanch va kechuvlar muhandislik fikrinin yodgorliklari sifatida saqlanib qolgan'],
      qq: ['Ámiwdárya ústinen ótiwler mıń jıllar dawamında sawda hám harbiy júrishlerde tiykarǵı rol atqarǵan', 'Birinshi dáyimli kópirler XIX ásirde Rossiya ádministratsiyası kelgennen keyin payda boldı', 'Ayırım tariyxıy tiremlew hám keshiwler injenerlik oyınıń yadgorlikleri retinde saqlanǵan'],
    },
  },
];